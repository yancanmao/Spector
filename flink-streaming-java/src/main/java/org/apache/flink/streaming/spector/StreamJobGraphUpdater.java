...
public class StreamJobGraphUpdater extends JobGraphUpdater {

	static final Logger LOG = LoggerFactory.getLogger(StreamJobGraphUpdater.class);

	public StreamJobGraphUpdater(JobGraph jobGraph, ClassLoader userCodeLoader) {
