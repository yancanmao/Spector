...
def ReadFile():
    ...
    coly = []
    cur_ts = 0
    f = open(FILE_FOLER + "/spector-{}-{}-{}-{}/log/flink-myc-standalonesession-0-camel-sane.out"
...
if __name__ == '__main__':
    ...
    legend = True
    DrawFigure(x_axis, y_axis, legend_labels, "Elapsed Time (s)", "Memory Consuming (mb)", "memory_consumption_jm", legend)